...
<body>
    ...
    <!-- START -->
    <section id="about-start" class="navbar-margin">
        <div class="container">
            <h1 data-aos="fade-up">About <span class="pri">me</span></h1>
        </div>
    </section>
                ...
                <div class="col-md-8 mt-5">
                    ...
                    <p data-aos="fade-up" data-aos-delay="400">Hey there I’m Additi.
                        As a Dedicated <span class="pri-bold">Wellness Coach</span>, I want to share with you a <span
                            class="pri-bold">Course
                            of Action</span>, on how You can
                        easily incorporate nutrition
                        balancing and fitness into your <span class="pri-bold">busy</span> lifestyle.
                        You could be a <span class="pri-bold">work-o-holic, a busy mom or a student</span> and in spite
                        of all the busy ness you can
                        still rep the fitness
                        star version of yourself.</p>
                ...
                <div class="col-lg-7 mt-5">
                    <p data-aos="fade-up" data-aos-delay="400">And I just <span class="pri-bold">don’t talk the talk. I
                        ...
                        didn’t have a health philosophy. Until, one day, I was introduced to a <span
                            class="pri-bold">Fit community</span> that helped
                        me create a lifestyle plan that was <span class="pri-bold">Easy to follow</span> and with <span
                            class="pri-bold">No diet restrictions</span> and that one
                        day CHANGED MY LIFE. I want this day to be THAT DAY that changes your life too. </p>
                    <p data-aos="fade-up" data-aos-delay="400">My own transformation triggered my interest in learning
